...
tr::Event::operator KeyDownEvent() const noexcept
{
    ...
    return {
        .win = WindowView { SDL_GetWindowFromID(sdl.key.windowID) },
        .repeat = bool(sdl.key.repeat),
        .key {
            .scan = Scancode::Enum(sdl.key.keysym.scancode),
...
tr::Event::operator TextEditEvent() const noexcept
{
    ...
    TextEditEvent event {
        .win = WindowView { SDL_GetWindowFromID(sdl.edit.windowID) },
        .text = sdl.edit.text
    };
...
tr::Event::operator TextInputEvent() const noexcept
{
    ...
    return {
        .win = WindowView { SDL_GetWindowFromID(sdl.text.windowID) },
        .text = sdl.text.text
    };
}
...
tr::Event::operator MouseMotionEvent() const noexcept
{
    ...
    return {
        .win = WindowView { SDL_GetWindowFromID(sdl.motion.windowID) },
...
tr::Event::operator MouseDownEvent() const noexcept
{
    ...
    return {
        .win = WindowView { SDL_GetWindowFromID(sdl.button.windowID) },
...
tr::Event::operator MouseWheelEvent() const noexcept
{
    ...
    return {
        .win = WindowView { SDL_GetWindowFromID(sdl.wheel.windowID) },
...
tr::Event::operator WindowEvent() const noexcept
{
    ...
    case SDL_WINDOWEVENT_ENTER:
        return WindowEnterEvent {
            .win = WindowView { SDL_GetWindowFromID(sdl.window.windowID) }
        };
