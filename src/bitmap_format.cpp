...
{
	return SDL_GetPixelFormatName(SDL_PixelFormat(_type));
}

tr::BitmapFormat::Order tr::BitmapFormat::order() const noexcept
{
	int order{SDL_PIXELORDER(SDL_PixelFormat(_type))};
	if (isPacked()) {
...
{
	return Layout(SDL_PIXELLAYOUT(SDL_PixelFormat(_type)));
}

int tr::BitmapFormat::pixelBits() const noexcept
{
	return SDL_BITSPERPIXEL(SDL_PixelFormat(_type));
}

int tr::BitmapFormat::pixelBytes() const noexcept
{
	return SDL_BYTESPERPIXEL(SDL_PixelFormat(_type));
}

bool tr::BitmapFormat::isIndexed() const noexcept
{
	return SDL_ISPIXELFORMAT_INDEXED(SDL_PixelFormat(_type));
}

bool tr::BitmapFormat::isPacked() const noexcept
{
	return SDL_ISPIXELFORMAT_PACKED(SDL_PixelFormat(_type));
}

bool tr::BitmapFormat::isArray() const noexcept
{
	return SDL_ISPIXELFORMAT_ARRAY(SDL_PixelFormat(_type));
}

bool tr::BitmapFormat::hasAlpha() const noexcept
{
	return SDL_ISPIXELFORMAT_ALPHA(SDL_PixelFormat(_type));
}
