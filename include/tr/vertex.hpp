...
namespace tr {
	 ...
	 *******************************************************************************************************************/
	template <class T>
	concept PositionsRange = std::ranges::range<T> && requires(std::ranges::range_value_t<T> val) { val.pos; };
	 ...
	 *******************************************************************************************************************/
	template <class T>
	concept UVsRange = std::ranges::range<T> && requires(std::ranges::range_value_t<T> val) { val.uv; };
	 ...
	 *******************************************************************************************************************/
	template <class T>
	concept ColorsRange = std::ranges::range<T> && requires(std::ranges::range_value_t<T> val) { val.color; };
	...
	struct Positions {
		 ...
		 **************************************************************************************************************/
		template <PositionsRange R> constexpr auto operator()(R&& range) const noexcept;
	};
	 ...
	 * @return The transformed view.
	 ******************************************************************************************************************/
	template <PositionsRange R> constexpr auto operator|(R&& range, const Positions&) noexcept;
	...
	struct UVs {
		 ...
		 * @return The transformed view.
		 **************************************************************************************************************/
		template <UVsRange R> constexpr auto operator()(R&& range) const noexcept;
	};
	 ...
	 * @return The transformed view.
	 ******************************************************************************************************************/
	template <UVsRange R> constexpr auto operator|(R&& range, const UVs&) noexcept;
	...
	struct Colors {
		 ...
		 * @return The transformed view.
		 **************************************************************************************************************/
		template <ColorsRange R> constexpr auto operator()(R&& range) const noexcept;
	};
	 ...
	 * @return The transformed view.
	 ******************************************************************************************************************/
	template <ColorsRange R> constexpr auto operator|(R&& range, const Colors&) noexcept;
...
template <tr::PositionsRange R> constexpr auto tr::operator|(R&& range, const Positions&) noexcept
{
	return positions(range);
}

template <tr::PositionsRange R> constexpr auto tr::Positions::operator()(R&& range) const noexcept
{
	return range | project(&std::ranges::range_value_t<R>::pos);
}

template <tr::UVsRange R> constexpr auto tr::operator|(R&& range, const UVs&) noexcept
{
	return uvs(range);
}

template <tr::UVsRange R> constexpr auto tr::UVs::operator()(R&& range) const noexcept
{
	return range | project(&std::ranges::range_value_t<R>::uv);
}

template <tr::ColorsRange R> constexpr auto tr::operator|(R&& range, const Colors&) noexcept
{
	return colors(range);
}

template <tr::ColorsRange R> constexpr auto tr::Colors::operator()(R&& range) const noexcept
{
