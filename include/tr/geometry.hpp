...
namespace tr {
	...
	struct Rect {
	     ...
	     **************************************************************************************************************/
		template <class T1>
		constexpr Rect(const Rect<S, T1>& rect) noexcept;

		/**************************************************************************************************************
	     * Equality comparison operator.
	     **************************************************************************************************************/
		template <class T1>
		constexpr bool operator==(const Rect<S, T1>&) const noexcept;
	     ...
	     **************************************************************************************************************/
		template <class T1>
		constexpr bool contains(glm::vec<S, T1> point) const noexcept;
	};
	...
	struct Circle {
	     ...
	     **************************************************************************************************************/
		template <class T1>
		constexpr Circle(const Circle<T1>& circle) noexcept;

		/**************************************************************************************************************
	     * Equality comparison operator.
	     **************************************************************************************************************/
		template <class T1>
		constexpr bool operator==(const Circle<T1>& r) const noexcept;
	     ...
	     **************************************************************************************************************/
		template <class T1>
		constexpr bool contains(glm::tvec2<T1> point) const noexcept;
	};
	...
	bool intersecting(const Rect2<T1>& r1, const Rect2<T2>& r2) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <class T>
	bool intersecting(const Circle<T>& c1, const Circle<T>& c2) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <std::floating_point T>
	constexpr std::optional<glm::tvec2<T>>
	segmentIntersect(glm::tvec2<T> a1, glm::tvec2<T> b1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <std::integral T>
	constexpr std::optional<glm::dvec2>
	segmentIntersect(glm::tvec2<T> a1, glm::tvec2<T> b1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <std::floating_point T>
	std::optional<glm::tvec2<T>>
	segmentIntersect(glm::tvec2<T> a1, Angle<T> th1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	...
	segmentIntersect(glm::tvec2<T> a1, AngleD th1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	...
	template <std::floating_point T>
	constexpr std::optional<glm::tvec2<T>>
	intersect(glm::tvec2<T> a1, glm::tvec2<T> b1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	...
	std::common_type_t<T1, T2> mod(T1 v, T2 mod) noexcept;
	...
	T mirrorRepeat(T v, T min, T max) noexcept;
     ...
     * @return The inverse vector.
	 ******************************************************************************************************************/
	template <std::size_t S, std::integral T>
	constexpr glm::vec<S, double> inverse(const glm::vec<S, T>& vec) noexcept;
	...
	inline namespace matrix_operators {
	     ...
	     **************************************************************************************************************/
		template <class T>
		constexpr glm::tvec2<T> operator*(const glm::tvec2<T>& v, const glm::tmat4x4<T>& m) noexcept;
	     ...
	     **************************************************************************************************************/
		template <class T>
		constexpr glm::tvec3<T> operator*(const glm::tvec3<T>& v, const glm::tmat4x4<T>& m) noexcept;
	     ...
	     **************************************************************************************************************/
		template <class T>
		constexpr glm::tvec2<T> operator*(const glm::tmat4x4<T>& m, const glm::tvec2<T>& v) noexcept;
	     ...
	     **************************************************************************************************************/
		template <class T>
		constexpr glm::tvec3<T> operator*(const glm::tmat4x4<T>& m, const glm::tvec3<T>& v) noexcept;
	...
	template <class T>
	glm::tmat4x4<T>
	scaleAroundPoint2(const glm::tmat4x4<T>& matrix, const glm::tvec2<T>& center, const glm::tvec2<T>& scale) noexcept;
	...
	template <class T>
	glm::tmat4x4<T>
	scaleAroundPoint3(const glm::tmat4x4<T>& matrix, const glm::tvec3<T>& center, const glm::tvec3<T>& scale) noexcept;
	...
	template <class T>
	glm::tmat4x4<T>
	rotateAroundPoint2(const glm::tmat4x4<T>& matrix, const glm::tvec2<T>& center, const Angle<T>& angle) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <class T>
	glm::tmat4x4<T> rotateAroundPoint3(
		const glm::tmat4x4<T>& matrix,
...
template <class T>
template <class T1>
constexpr bool tr::Circle<T>::contains(glm::tvec2<T1> point) const noexcept
{
...
template <std::floating_point T>
constexpr std::optional<glm::tvec2<T>>
tr::segmentIntersect(glm::tvec2<T> a1, glm::tvec2<T> b1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept
{
	auto          r {b2 - a2};
...
template <std::floating_point T>
std::optional<glm::tvec2<T>>
tr::segmentIntersect(glm::tvec2<T> a1, Angle<T> th1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept
{
	auto          r {b2 - a2};
...
template <std::integral T>
std::optional<glm::dvec2>
tr::segmentIntersect(glm::tvec2<T> a1, AngleD th1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept
{
...
template <std::floating_point T>
constexpr std::optional<glm::tvec2<T>>
tr::intersect(glm::tvec2<T> a1, glm::tvec2<T> b1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept
{
	auto          r {b2 - a2};
	glm::tvec2<T> n {b1.y - a1.y, -b1.x + a1.x};
	auto          d {dot(r, n)};
...
template <std::size_t S, std::floating_point T>
constexpr glm::vec<S, T> tr::inverse(const glm::vec<S, T>& vec) noexcept
{
	glm::vec<S, T> result;
	for (std::size_t i = 0; i < S; ++i) {
		result[i] = T(1) / vec[i];
...
template <std::size_t S, std::integral T>
constexpr glm::vec<S, double> tr::inverse(const glm::vec<S, T>& vec) noexcept
{
...
template <class T>
glm::tmat4x4<T>
tr::scaleAroundPoint2(const glm::tmat4x4<T>& matrix, const glm::tvec2<T>& center, const glm::tvec2<T>& scale) noexcept
{
...
template <class T>
glm::tmat4x4<T>
tr::rotateAroundPoint2(const glm::tmat4x4<T>& matrix, const glm::tvec2<T>& center, const Angle<T>& angle) noexcept
{
	return rotateAroundPoint3(matrix, {center, 0}, angle, Z_AXIS);
}

template <class T>
glm::tmat4x4<T> tr::rotateAroundPoint3(
	const glm::tmat4x4<T>& matrix,
	const glm::tvec3<T>&   center,
	const Angle<T>&        angle,
	const glm::tvec3<T>&   axis
