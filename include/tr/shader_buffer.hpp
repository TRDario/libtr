	...
	class ShaderBuffer : public GraphicsBuffer {
	  public:
		...
		enum class Access : std::uint32_t {
			 ...
			 **********************************************************************************************************/
			READ_ONLY = static_cast<std::uint32_t>(Flag::READABLE),

			/**********************************************************************************************************
			 * Buffer maps are write-only.
			 **********************************************************************************************************/
			WRITE_ONLY = static_cast<std::uint32_t>(Flag::WRITABLE),

			/**********************************************************************************************************
			 * Buffer maps are readable and writable.
			 **********************************************************************************************************/
			READ_WRITE = static_cast<std::uint32_t>(Flag::READABLE) | static_cast<std::uint32_t>(Flag::WRITABLE)
		};
