...
namespace tr {
	 ...
	 ******************************************************************************************************************/
	template <std::floating_point T>
    constexpr std::optional<glm::tvec2<T>> segmentIntersect(glm::tvec2<T> a1, glm::tvec2<T> b1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <std::integral T> 
    constexpr std::optional<glm::dvec2> segmentIntersect(glm::tvec2<T> a1, glm::tvec2<T> b1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <std::floating_point T>
    std::optional<glm::tvec2<T>> segmentIntersect(glm::tvec2<T> a1, Angle<T> th1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <std::integral T>
    std::optional<glm::dvec2> segmentIntersect(glm::tvec2<T> a1, AngleD th1, glm::tvec2<T> a2, glm::tvec2<T> b2) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <class T>
    glm::tmat4x4<T> scaleAroundPoint2(const glm::tmat4x4<T>& matrix, const glm::tvec2<T>& center, const glm::tvec2<T>& scale) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <class T>
    glm::tmat4x4<T> scaleAroundPoint3(const glm::tmat4x4<T>& matrix, const glm::tvec3<T>& center, const glm::tvec3<T>& scale) noexcept;
	 ...
	 ******************************************************************************************************************/
	template <class T>
    glm::tmat4x4<T> rotateAroundPoint2(const glm::tmat4x4<T>& matrix, const glm::tvec2<T>& center, const Angle<T>& angle) noexcept;
...
{
    return r1.contains(r2.tl) || r1.contains(r2.tl + r2.size) || r2.contains(r1.tl + glm::tvec2<T1> { r1.size.x, 0 }) || r2.contains(r1.tl + glm::tvec2<T1> { 0, r1.size.y });
}
...
template <class T>
glm::tmat4x4<T> tr::scaleAroundPoint2(const glm::tmat4x4<T>& matrix, const glm::tvec2<T>& center, const glm::tvec2<T>& scale) noexcept
{
    return scaleAroundPoint3(matrix, { center, 0 }, { scale, 1 });
}

template <class T>
glm::tmat4x4<T> tr::scaleAroundPoint3(const glm::tmat4x4<T>& matrix, const glm::tvec3<T>& center, const glm::tvec3<T>& scale) noexcept
{
    return translate(scale(translate(matrix, center), scale), -center);
}

template <class T>
glm::tmat4x4<T> tr::rotateAroundPoint2(const glm::tmat4x4<T>& matrix, const glm::tvec2<T>& center, const Angle<T>& angle) noexcept
{
    return rotateAroundPoint3(matrix, { center, 0 }, angle, Z_AXIS);
}

template <class T>
glm::tmat4x4<T> tr::rotateAroundPoint3(const glm::tmat4x4<T>& matrix, const glm::tvec3<T>& center, const Angle<T>& angle, const glm::tvec3<T>& axis) noexcept
{
